...
PG_PROD_APPLICATION_ID = _env('BOOTPAY_PG_APPLICATION_ID_PROD', '')
PG_PROD_PRIVATE_KEY = _env('BOOTPAY_PG_PRIVATE_KEY_PROD', '')
PG_DEV_APPLICATION_ID = _env('BOOTPAY_PG_APPLICATION_ID_DEV', '')
PG_DEV_PRIVATE_KEY = _env('BOOTPAY_PG_PRIVATE_KEY_DEV', '')
